...
#define CONFIG_AP_WIFI_SSID "ap-ssid"
#define CONFIG_AP_WIFI_PASSWORD "ap-password"
#define CONFIG_AP_WIFI_CHANNEL 1
#define CONFIG_AP_MAX_STA_CONN 4
#define CONFIG_STA_WIFI_SSID "sta-ssid"
#define CONFIG_STA_WIFI_PASSWORD "sta-password"
